...
// Backend URL that Instagram redirects to, then this forwards to smartreel://instagram-callback
  ...
  const connect = useCallback((): Promise<{ error?: string }> => {
    return new Promise(async (resolve) => {
      ...
      try {
        ...
        // openAuthSessionAsync detects the smartreel:// redirect and returns it
